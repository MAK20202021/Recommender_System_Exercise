...
class Recommender():
    '''
    This Recommender uses FunkSVD to make predictions of exact ratings. Here either FunkSVD or a Knowledge Based recommendation (highest ranked) is used to make recommendations for users.  
    At the end, for a given movie, the recommender will provide movies that are most similar as a Content Based Recommender.
    '''
    def __init__(self, ):
        '''
        For thsi perticular exercise we do not need any attributes
        '''
    ...
    def fit(self,reviews_pth, movies_pth, latent_features=12, learning_rate=0.0001, iters=100 ):
        '''
        fit the recommender to the dataset and also have this save the results
        to pull from when we need to make predictions
    ...
    def make_recs(self,_id, _id_type='movie', rec_num=3):
        '''
         INPUT:
